...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The SelectEditPayment recording.
    /// </summary>
    [TestModule("4c946765-f797-4015-8b08-a310fbe19bf6", ModuleType.Recording, 1)]
    public partial class SelectEditPayment : ITestModule
    {
        /// <summary>
        ...
        static SelectEditPayment instance = new SelectEditPayment();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public SelectEditPayment()
        {
        }
        ...
        /// </summary>
        public static SelectEditPayment Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Wait", "Waiting 10s for the attribute 'Visible' to equal the specified value 'True'. Associated repository item: 'EasternOnlineBankingDashboard.EditPaymentModal'", repo.EasternOnlineBankingDashboard.EditPaymentModal.SelfInfo, new RecordItemIndex(1));

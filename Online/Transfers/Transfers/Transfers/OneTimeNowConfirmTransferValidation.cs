...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The OneTimeNowConfirmTransferValidation recording.
    /// </summary>
    [TestModule("daba2a6a-8ce0-4962-92f0-5dbdc0f987db", ModuleType.Recording, 1)]
    public partial class OneTimeNowConfirmTransferValidation : ITestModule
    {
        /// <summary>
        ...
        static OneTimeNowConfirmTransferValidation instance = new OneTimeNowConfirmTransferValidation();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public OneTimeNowConfirmTransferValidation()
        {
            FromAccount = "2435";
        }
        ...
        /// </summary>
        public static OneTimeNowConfirmTransferValidation Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// <summary>
        /// Gets or sets the value of variable FromAccount.
        /// </summary>
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Visible='True') on item 'EasternOnlineBankingDashboard.ConfirmTransferDetailsModal.TransferOn'.", repo.EasternOnlineBankingDashboard.ConfirmTransferDetailsModal.TransferOnInfo, new RecordItemIndex(5));
            Validate.AttributeEqual(repo.EasternOnlineBankingDashboard.ConfirmTransferDetailsModal.TransferOnInfo, "Visible", "True");
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Validation", "Validating AttributeEqual (Visible='True') on item 'EasternOnlineBankingDashboard.ConfirmTransferDetailsModal.Amount'.", repo.EasternOnlineBankingDashboard.ConfirmTransferDetailsModal.AmountInfo, new RecordItemIndex(6));

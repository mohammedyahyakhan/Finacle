...
namespace Ios
{
    ...
    public class BillPay : BrowserStackNUnitTest
    {
        ...
        public void StartReport()
        {
            ...
            var reportPath = projectPath + "Reports\\" + "EasternBank_BillPay" + timestamp + ".html";
        ...
        public void Verifyaddpayeecompany()
        {
            ...
            entercompanyname.SendKeys("Discover");
            ...
            var enterAccNumber = (RemoteWebElement)new WebDriverWait(this.Driver, TimeSpan.FromMinutes(1)).Until(
            ExpectedConditions.ElementExists(By.XPath("//XCUIElementTypeTextField[1]")));
            discovercreditcards.Click();
            enterAccNumber.SendKeys("6011002775491234");
            ...
            save.Click();
            this.Test.Log(LogStatus.Pass, "add payee validated");
        }
        ...
        public void Verifyaddpayee()
        {
            ...
            var managepayees1 = (RemoteWebElement)new WebDriverWait(this.Driver, TimeSpan.FromMinutes(1)).Until(
            ExpectedConditions.ElementExists(By.XPath("//XCUIElementTypeButton[contains(@name,'Add a Payee')]")));
            Assert.AreEqual(true, managepayees1.Displayed);
            managepayees1.Click();
        ...
        public void Verifyaddpayeeperson()
        {
            ...
            ExpectedConditions.ElementExists(By.XPath("//XCUIElementTypeTextField[3]")));
            addressline.Click();
            ...
            ExpectedConditions.ElementExists(By.XPath("//XCUIElementTypeTextField[5]")));
            city.Click();
            city.SendKeys("Brighton");

            var state = (RemoteWebElement)new WebDriverWait(this.Driver, TimeSpan.FromMinutes(1)).Until(
            ExpectedConditions.ElementExists(By.XPath("//XCUIElementTypeOther[contains(@name,'State')]")));
            state.Click();
            state.SendKeys("MA");
           ...
           ExpectedConditions.ElementExists(By.XPath("//XCUIElementTypeOther[contains(@name,'MA')]")));
            ma.Click();
        ...
        public void Verifypayeenameerror()
        {
            ...
            var alert = (RemoteWebElement)new WebDriverWait(this.Driver, TimeSpan.FromMinutes(1)).Until(
           ExpectedConditions.ElementExists(By.XPath("//XCUIElementTypeStaticText[contains(@name,'Error: You must enter Payee Name.')]")));
            alert.Click();

            this.Test.Log(LogStatus.Pass, "Add payee name error is Displayed");
        }
        ...
        public void Verifyvalidcitystatezipcodeerror()
        {
           ...
           ExpectedConditions.ElementExists(By.XPath("//XCUIElementTypeStaticText[contains(@name,'Please enter a valid zip code.')]")));
            error.Click();

            this.Test.Log(LogStatus.Pass, "Add payee zip code error validated");

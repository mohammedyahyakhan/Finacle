...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The AdvanceSearchSetup recording.
    /// </summary>
    [TestModule("9d8a0f3b-25db-4893-861a-58f9f86e7e44", ModuleType.Recording, 1)]
    public partial class AdvanceSearchSetup : ITestModule
    {
        /// <summary>
        ...
        static AdvanceSearchSetup instance = new AdvanceSearchSetup();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public AdvanceSearchSetup()
        {
            varBrowser = "Chrome";
        ...
        /// </summary>
        public static AdvanceSearchSetup Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("29a23382-d9a4-48bd-8147-eccf14dbc25f")]
        ...
        /// </summary>
        [TestVariable("6d0e8d82-7906-4a10-a96c-333e08e6a235")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'stg123' with focus on 'ApplicationUnderTest.LoginCredentials_Signin.AuthenticationFGUSERPRINCIPAL'.", repo.ApplicationUnderTest.LoginCredentials_Signin.AuthenticationFGUSERPRINCIPALInfo, new RecordItemIndex(3));
            repo.ApplicationUnderTest.LoginCredentials_Signin.AuthenticationFGUSERPRINCIPAL.PressKeys("stg123");
            Delay.Milliseconds(0);
            ...
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence 'bank@12345' with focus on 'ApplicationUnderTest.LoginCredentials_Signin.AuthenticationFGACCESSCODE1'.", repo.ApplicationUnderTest.LoginCredentials_Signin.AuthenticationFGACCESSCODE1Info, new RecordItemIndex(6));
            repo.ApplicationUnderTest.LoginCredentials_Signin.AuthenticationFGACCESSCODE1.PressKeys("bank@12345");
            Delay.Milliseconds(0);

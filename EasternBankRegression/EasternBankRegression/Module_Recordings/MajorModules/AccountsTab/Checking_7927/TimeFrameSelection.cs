...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The TimeFrameSelection recording.
    /// </summary>
    [TestModule("10eb2de1-a256-4b8e-ade9-21f979ba34d2", ModuleType.Recording, 1)]
    public partial class TimeFrameSelection : ITestModule
    {
        /// <summary>
        ...
        static TimeFrameSelection instance = new TimeFrameSelection();
        ...
        /// </summary>
        public static TimeFrameSelection Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking PerformClick() on item 'EasternOnlineBankingDashboard.FilterButton10'.", repo.EasternOnlineBankingDashboard.FilterButton10Info, new RecordItemIndex(8));
            repo.EasternOnlineBankingDashboard.FilterButton10.PerformClick();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking PerformClick() on item 'EasternOnlineBankingDashboard.TimeframeDropdown7'.", repo.EasternOnlineBankingDashboard.TimeframeDropdown7Info, new RecordItemIndex(9));
            repo.EasternOnlineBankingDashboard.TimeframeDropdown7.As<WebElement>().PerformClick();
            Delay.Milliseconds(0);
            
            Report.Log(ReportLevel.Info, "Invoke action", "Invoking PerformClick() on item 'EasternOnlineBankingDashboard.TopBar.TimeframetimeFrm6'.", repo.EasternOnlineBankingDashboard.TopBar.TimeframetimeFrm6Info, new RecordItemIndex(10));
            repo.EasternOnlineBankingDashboard.TopBar.TimeframetimeFrm6.Element.InvokeActionWithText("PerformClick");
            Delay.Milliseconds(0);
